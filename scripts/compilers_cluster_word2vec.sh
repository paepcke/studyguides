...
export SRT_ROOT='/Users/andrewlamb/Google_Drive/Stanford/CS199/CompilersSelfPacedCS1'
...
word2vec -train ${SRT_ROOT}/captions.txt -output ${SRT_ROOT}/classes.txt \
         -classes 200 -debug 2 -save-vocab ${SRT_ROOT}/vocab.txt -iter 50 -debug 2
sort ${SRT_ROOT}/classes.txt -k 2 -n > ${SRT_ROOT}/classes.sorted.txt